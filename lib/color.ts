...
import type { Color, ContrastInfo, CssColorFormat, HSL, OKLCH, RGB } from "./model";
...
class ColorImpl implements Color {
    ...
    oklch(): OKLCH {
        if (!this._oklch) {
            return rgbToOklch(this._r, this._g, this._b);
        }
        return this._oklch;
    }
    ...
    private get luminance(): number {
        if (this._luminance === undefined) {
            return relativeLuminance(this._r, this._g, this._b);
        }
